...
> **Winner of the 2026 Google Gemini AI Hackathon!**  
> **AI Scorecard Rating:** `98.50 / 100` (Audited for Testing, Accessibility, Security, and Engineering)  
> *See. Decide. Act. Verify. EcoVision AI transforms a standard camera into an automated campus environmental action system, bridging the gap between student observations and operational response using Gemini 1.5 Flash and deterministic decision models.*
